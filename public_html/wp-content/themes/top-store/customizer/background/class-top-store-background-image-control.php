...
class Top_Store_Customize_Custom_Background_Control extends WP_Customize_Upload_Control{
	...
	public static function get_button_labels() {
		...
		$button_labels = array(
			'select'       => __( 'Select Image', 'top-store' ),
			'change'       => __( 'Change Image', 'top-store' ),
			'remove'       => __( 'Remove', 'top-store' ),
			'default'      => __( 'Default', 'top-store' ),
			'placeholder'  => __( 'No image selected', 'top-store' ),
			'frame_title'  => __( 'Select Image', 'top-store' ),
			'frame_button' => __( 'Choose Image', 'top-store' ),
		);
	...
	public static function get_field_labels() {
		...
		$field_labels = array(
			'repeat'	=> __( 'Background Repeat', 'top-store' ),
			'size'		=> __( 'Background Size', 'top-store' ),
			'position'	=> __( 'Background Position', 'top-store' ),
			'attach'	=> __( 'Background Attachment', 'top-store' )
		);
	...
	public static function get_background_choices() {
		...
		$choices = array(
			'repeat' => array(
				'no-repeat' => __( 'No Repeat', 'top-store' ),
				'repeat'    => __( 'Tile', 'top-store' ),
				'repeat-x'  => __( 'Tile Horizontally', 'top-store' ),
				'repeat-y'  => __( 'Tile Vertically', 'top-store' )
			),
			'size' => array(
				'auto'    => __( 'Default', 'top-store' ),
				'cover'   => __( 'Cover', 'top-store' ),
				'contain' => __( 'Contain', 'top-store' )
			),
			'position' => array(
				'left top'      => __( 'Left Top', 'top-store' ),
				'left center'   => __( 'Left Center', 'top-store' ),
				'left bottom'   => __( 'Left Bottom', 'top-store' ),
				'right top'     => __( 'Right Top', 'top-store' ),
				'right center'  => __( 'Right Center', 'top-store' ),
				'right bottom'  => __( 'Right Bottom', 'top-store' ),
				'center top'    => __( 'Center Top', 'top-store' ),
				'center center' => __( 'Center Center', 'top-store' ),
				'center bottom' => __( 'Center Bottom', 'top-store' )
			),
			'attach' => array(
				'fixed'   => __( 'Fixed', 'top-store' ),
				'scroll'  => __( 'Scroll', 'top-store' )
			)
		);
